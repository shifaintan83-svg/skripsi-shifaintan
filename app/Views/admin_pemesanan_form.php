          ...
          <form action="<?=$action?>" class="row g-3 needs-validation <?=$was_validated?>" method="POST" novalidate>
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                <input type="datetime-local" name="jadwal_pemesanan" class="form-control" value="<?=$jadwal_pemesanan?>">
            ...
            <div class="col-12">
              ...
              <select id="id_layanan" name="id_layanan" class="form-control select2" style="width:100%" onchange="updateBiaya()" >
            ...
            <div class="col-12">
              <label>Biaya</label>
              <input type="text" name="biaya" id="biaya_layanan" class="form-control number" value="<?=number_format($biaya)?>"/>
            </div>
            <div class="col-12">
